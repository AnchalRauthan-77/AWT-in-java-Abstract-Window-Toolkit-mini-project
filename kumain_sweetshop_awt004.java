...
class kumain_sweetshop_awt004 extends Frame implements ActionListener
{
	...
	{
		l7=new Label("Kumain Sweet Shop");
		l7.setBounds(100,50,500,30);
		...
		list1.add("Student");
		list1.add("Staff");
		list1.setBounds(50,220,100,50);
		list1.setFont(new Font("Times new Roman",Font.BOLD,15));
		
		l4=new Label("Total");
		l4.setBounds(190,210,100,20);
		l4.setFont(new Font("Times new Roman",Font.BOLD,15));
		
		l5=new Label("Discount");
		l5.setBounds(190,240,100,20);
		l5.setFont(new Font("Times new Roman",Font.BOLD,15));
		
		l6=new Label("Amount");
		l6.setBounds(190,270,100,20);
		l6.setFont(new Font("Times new Roman",Font.BOLD,15));
		
		tf1=new TextField(15);
		tf1.setBounds(170,120,100,20);
		
		tf2=new TextField(15);
		tf2.setBounds(170,150,100,20);
		
		tf3=new TextField(15);
		tf3.setBounds(170,180,100,20);
		
		tf4=new TextField(15);
		tf4.setBounds(290,120,100,20);
	
		cb1=new Checkbox("Chole");
		cb1.setBounds(405,120,100,20);
		
		tf5=new TextField(15);
		tf5.setBounds(290,150,100,20);
		
		cb2=new Checkbox("Dahi");
		cb2.setBounds(405,150,100,20);
		
		tf6=new TextField(15);
		tf6.setBounds(290,180,100,20);
		
		cb3=new Checkbox("Masala");
		cb3.setBounds(405,180,100,20);
		
		tf7=new TextField(15);
		tf7.setBounds(290,210,100,20);
		
		cb4=new Checkbox("kullad");
		cb4.setBounds(405,210,100,20);
		
		tf8=new TextField(15);
		tf8.setBounds(290,240,100,20);
		
		cb5=new Checkbox("Latte");
		cb5.setBounds(405,240,100,20);
		
		tf9=new TextField(15);
		tf9.setBounds(290,270,100,20);
		
		cb6=new Checkbox("Express");
		cb6.setBounds(405,270,100,20);
		
		b1=new Button("Calculate");
		b1.setBounds(170,310,100,20);
		b1.addActionListener(this);
		
		b2=new Button("Cancel");
		b2.setBounds(290,310,100,20);
